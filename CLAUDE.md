...
- `AutopilotTrenchCommand` — fully automatic trench pass using the [Autopilot library](https://github.com/therekrab/autopilot): APPROACH targets the trench *entrance* with nonzero end velocity, PASS retargets to the exit. Used in autonomous.
