...
public class Drive extends TunerSwerveDrivetrain implements Subsystem {
  ...
  /* Compatibility methods for the rest of the current robot project. */
  ...
  private SwerveModuleState[] getModuleStates() {
    return getStateCopy().ModuleStates;
  }

  private SwerveModulePosition[] getModulePositions() {
    return getStateCopy().ModulePositions;
  }
  ...
  public double[] getWheelRadiusCharacterizationPositions() {
    ...
    for (int i = 0; i < positions.length; i++) {
      values[i] = positions[i].distanceMeters / TunerConstants.FrontLeft.WheelRadius;
    }
    return values;
  }
  ...
  public double getFFCharacterizationVelocity() {
    ...
    for (SwerveModuleState state : states) {
      output += state.speedMetersPerSecond / states.length;
    }
    return output;
  }
