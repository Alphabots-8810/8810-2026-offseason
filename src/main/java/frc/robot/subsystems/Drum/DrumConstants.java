...
public final class DrumConstants {
  ...
  public static final int Drum_LEADER_ID = 30;
  public static final int Drum_FOLLOWER_ID = 31;

  public static final double Drum_ROTOR_TO_MECHANISM_RATIO = 1.0;

  public static final double Drum_INTAKE_VOLTS = 6.0;
  public static final double Drum_FEED_VOLTS = 8.0;
  public static final double Drum_REVERSE_VOLTS = -4.0;
  public static final double Drum_IDLE_VOLTS = 0.0;
