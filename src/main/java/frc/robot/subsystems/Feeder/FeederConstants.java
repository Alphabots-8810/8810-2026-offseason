...
public final class FeederConstants {
  ...
  public static final int Feeder_LEADER_ID = 30;
  public static final int Feeder_FOLLOWER_ID = 31;

  public static final double Feeder_ROTOR_TO_MECHANISM_RATIO = 1.0;

  public static final double Feeder_INTAKE_VOLTS = 6.0;
  public static final double Feeder_FEED_VOLTS = 8.0;
  public static final double Feeder_REVERSE_VOLTS = -4.0;
  public static final double Feeder_IDLE_VOLTS = 0.0;

  public static final MotorIOPhoenix6Config Feeder_CONFIG =
      new MotorIOPhoenix6Config(Feeder_LEADER_ID, CAN_BUS)
          ...
          .withFollower(Feeder_FOLLOWER_ID, true);
